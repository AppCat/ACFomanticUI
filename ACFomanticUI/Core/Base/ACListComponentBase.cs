...
namespace ACUI.FomanticUI
{
    ...
    /// 
    /// </summary>
    public class ACListComponentBase : ACContentComponentBase, IFItemList
    {
        /// <summary>
        /// 项目
        /// </summary>
        protected Dictionary<string, IFItem> Items = new();

        /// <summary>
        /// 当前聚焦项目
        /// </summary>
        protected IFItem FocusItem { get; set; }
        ...
        /// </summary>
        [Parameter]
        public EventCallback<IFItem> OnFocusItem { get; set; }

        /// <summary>
        /// 选中的项目
        /// </summary>
        [Parameter]
        public EventCallback<IFItem> OnSelectedItem { get; set; }

        /// <summary>
        /// 点击的项目
        /// </summary>
        [Parameter]
        public EventCallback<IFItem> OnClickItem { get; set; }
        ...
        /// 当前项目
        /// </summary>
        /// <returns>IFItem / Null</returns>
        internal virtual IFItem CurrentItem()
        {
            if (SelectedKeys != null && SelectedKeys.Length > 0)
            {
                var key = SelectedKeys[SelectedKeys.Length - 1];
                if (Items.TryGetValue(key, out IFItem item))
                {
                    return item;
                }
            }
        ...
        /// <returns></returns>
        public virtual bool AddItem(IFItem item)
        {
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public virtual async Task FocusItemAsync(IFItem item)
        {
        ...
        public virtual async Task SelectedItemAsync(IFItem item, bool isClick = false)
        {
            if (item == null || item.Key == null || item.Disabled)
                return;
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public virtual bool ItemIsSelected(IFItem item)
        {
            if (item == null || item.Key == null)
                return false;
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public virtual bool ItemIsFocus(IFItem item)
        {
            if (item == null || item.Key == null)
                return false;
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public virtual bool ItemIsFiltered(IFItem item)
        {
            if (item == null || item.Key == null)
                return false;

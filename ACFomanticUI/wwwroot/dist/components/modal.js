...
; (function ($, window, document, undefined) {
                ...
                module = {
                    ...
                    event: {
                        approve: async function () {
                            if (ignoreRepeatedEvents || settings.onApprove.call(element, $(this)) === false || await settings.onApproveAsync.call(element, $(this)) === false) {
                        ...
                        deny: async function () {
                            if (ignoreRepeatedEvents || settings.onDeny.call(element, $(this)) === false || await settings.onDenyAsync.call(element, $(this)) === false) {
                    ...
                    hide: async function (callback) {
                        callback = $.isFunction(callback)
                            ? callback
                            : function () { }
                            ;
                        module.refreshModals();
                        return await module.hideModal(callback);
                    },
                    ...
                    hideModal: async function (callback, keepDimmed, hideOthersToo) {
                        var
                        ...
                        if (settings.onHide.call(element, $(this)) === false || await settings.onHideAsync.call(element, $(this)) === false) {
    ...
    $.fn.modal.settings = {
        ...
        // called before hide animation
        onHideAsync: async function () { return true; },
        ...
        // called after approve selector match
        onApproveAsync: async function () { return true; },

        // called after deny selector match
        onDeny: function () { return true; },

        // called after deny selector match
        onDenyAsync: async function () { return true; },
